...
struct FVector2D UWidgetBlueprintLibrary::GetWidgetCenterInViewport(class UObject* WorldContextObject, class UWidget* TargetWidget)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("WidgetBlueprintLibrary", "GetWidgetCenterInViewport");

	Params::WidgetBlueprintLibrary_GetWidgetCenterInViewport Parms{};
