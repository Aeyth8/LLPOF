...
public:
	...
	FMulticastInlineDelegateProperty_             OnValueChanged;                                    // 0x04E0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemDropped;                                     // 0x04F0(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPropertyDropped;                                 // 0x0500(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	float                                         MaxRangeForOcclusionChecks;                        // 0x0278(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_27C[0x194];                                    // 0x027C(0x0194)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAkComponent) == 0x000410, "Wrong size on UAkComponent");
...
static_assert(offsetof(UAkComponent, MaxRangeForOcclusionChecks) == 0x000278, "Member 'UAkComponent::MaxRangeForOcclusionChecks' has a wrong offset!");
...
static_assert(sizeof(UAkAudioInputComponent) == 0x000440, "Wrong size on UAkAudioInputComponent");
...
public:
	...
	FMulticastInlineDelegateProperty_             AkOnCheckStateChanged;                             // 0x0A50(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnItemDropped;                                     // 0x0A60(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPropertyDropped;                                 // 0x0A70(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UDrawPortalComponent) == 0x000460, "Wrong size on UDrawPortalComponent");
...
static_assert(sizeof(UDrawRoomComponent) == 0x000460, "Wrong size on UDrawRoomComponent");
...
{
public:
	FMulticastInlineDelegateProperty_             OnSelectionChanged;                                // 0x0108(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnPropertyDragged;                                 // 0x0118(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AAkSpotReflector) == 0x000248, "Wrong size on AAkSpotReflector");
...
public:
	...
	class USoundSubmix*                           SubmixToRecord;                                    // 0x0448(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAkSubmixInputComponent) == 0x0004A0, "Wrong size on UAkSubmixInputComponent");
static_assert(offsetof(UAkSubmixInputComponent, SubmixToRecord) == 0x000448, "Member 'UAkSubmixInputComponent::SubmixToRecord' has a wrong offset!");
