...
static_assert(offsetof(UNavLinkComponent, Links) == 0x000460, "Member 'UNavLinkComponent::Links' has a wrong offset!");
...
static_assert(sizeof(UNavMeshRenderingComponent) == 0x000470, "Wrong size on UNavMeshRenderingComponent");
...
static_assert(sizeof(UNavTestRenderingComponent) == 0x000460, "Wrong size on UNavTestRenderingComponent");
