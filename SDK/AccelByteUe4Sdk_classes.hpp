...
static_assert(sizeof(UABAchievement) == 0x000038, "Wrong size on UABAchievement");
...
static_assert(sizeof(UABAgreement) == 0x000038, "Wrong size on UABAgreement");
...
static_assert(sizeof(UABBinaryCloudSave) == 0x000038, "Wrong size on UABBinaryCloudSave");
...
static_assert(sizeof(UABBlock) == 0x000038, "Wrong size on UABBlock");
...
static_assert(sizeof(UABCatalog) == 0x000038, "Wrong size on UABCatalog");
...
static_assert(sizeof(UABCloudSave) == 0x000038, "Wrong size on UABCloudSave");
...
static_assert(sizeof(UABCurrency) == 0x000038, "Wrong size on UABCurrency");
...
static_assert(sizeof(UABEntitlement) == 0x000038, "Wrong size on UABEntitlement");
...
static_assert(sizeof(UABFriends) == 0x000038, "Wrong size on UABFriends");
...
static_assert(sizeof(UABFulfillment) == 0x000038, "Wrong size on UABFulfillment");
...
public:
	void AcceptGroupInvitation(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void AcceptGroupJoinRequest(const class FString& UserId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void AcceptV2GroupInvitation(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void AcceptV2GroupJoinRequest(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void AssignMemberRole(const class FString& MemberRoleId, const struct FAccelByteModelsUserIdWrapper& RequestContent, const TDelegate<void(struct FAccelByteModelsGetUserGroupInfoResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void AssignV2MemberRole(const class FString& MemberRoleId, const class FString& GroupId, const struct FAccelByteModelsUserIdWrapper& RequestContent, const TDelegate<void(struct FAccelByteModelsGetUserGroupInfoResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void CancelGroupMemberInvitation(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void CancelJoinGroupRequest(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void CreateGroup(const struct FAccelByteModelsCreateGroupRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void CreateV2Group(const struct FAccelByteModelsCreateGroupRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	void GetAllMemberRoles(const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRolesListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroup(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupInviteRequestList(const class FString& GroupId, const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRequestsListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupJoinRequestList(const class FString& GroupId, const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRequestsListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupJoinRequests(const class FString& GroupId, const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRequestsListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupList(const struct FAccelByteModelsGetGroupListRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetGroupListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupMembersListByGroupId(const class FString& GroupId, const struct FAccelByteModelsGetGroupMembersListByGroupIdRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetGroupMemberListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetGroupsByGroupIds(const TArray<class FString>& GroupIds, const TDelegate<void(struct FAccelByteModelsGetGroupListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetMemberRoles(const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRolesListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetMyJoinedGroupInfo(const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetGroupMemberListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetMyJoinGroupRequest(const struct FAccelByteModelsLimitOffsetRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetMemberRequestsListResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetUserGroupInfoByUserId(const class FString& UserId, const TDelegate<void(struct FAccelByteModelsGetUserGroupInfoResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetUserGroupStatusInfo(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsGetUserGroupInfoResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)> OnError);
	void InviteUserToGroup(const class FString& UserId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void InviteUserToV2Group(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void JoinGroup(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsJoinGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void JoinV2Group(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsJoinGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void KickGroupMember(const class FString& UserId, const TDelegate<void(struct FAccelByteModelsKickGroupMemberResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void KickV2GroupMember(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsKickGroupMemberResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void LeaveGroup(const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void LeaveV2Group(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void RejectGroupInvitation(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void RejectGroupJoinRequest(const class FString& UserId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void RejectV2GroupInvitation(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void RejectV2GroupJoinRequest(const class FString& UserId, const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsMemberRequestGroupResponse& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroup(const class FString& GroupId, const bool bCompletelyReplace, struct FAccelByteModelsGroupUpdatable* RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroupCustomAttributes(const class FString& GroupId, struct FAccelByteModelsUpdateGroupCustomAttributesRequest* RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroupCustomRule(const class FString& GroupId, struct FAccelByteModelsUpdateCustomRulesRequest* RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateGroupPredefinedRule(const class FString& GroupId, const EAccelByteAllowedAction& AllowedAction, const struct FAccelByteModelsUpdateGroupPredefinedRuleRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateV2Group(const class FString& GroupId, const struct FAccelByteModelsUpdateGroupRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateV2GroupCustomAttributes(const class FString& GroupId, const struct FAccelByteModelsUpdateGroupCustomAttributesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void UpdateV2GroupCustomRule(const class FString& GroupId, const struct FAccelByteModelsUpdateCustomRulesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
...
static_assert(sizeof(UABGroup) == 0x000038, "Wrong size on UABGroup");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ABInventory">();
	}
...
static_assert(alignof(UABInventory) == 0x000008, "Wrong alignment on UABInventory");
static_assert(sizeof(UABInventory) == 0x000038, "Wrong size on UABInventory");
...
static_assert(sizeof(UABLeaderboard) == 0x000038, "Wrong size on UABLeaderboard");
...
static_assert(sizeof(UABMatchmaking) == 0x000038, "Wrong size on UABMatchmaking");
...
static_assert(sizeof(UABMessage) == 0x000038, "Wrong size on UABMessage");
...
static_assert(sizeof(UABOrder) == 0x000038, "Wrong size on UABOrder");
...
static_assert(sizeof(UABParty) == 0x000038, "Wrong size on UABParty");
...
static_assert(sizeof(UABPresence) == 0x000038, "Wrong size on UABPresence");
...
static_assert(sizeof(UABReward) == 0x000038, "Wrong size on UABReward");
...
static_assert(sizeof(UABSeasonPass) == 0x000038, "Wrong size on UABSeasonPass");
...
static_assert(sizeof(UABServerAchievement) == 0x000038, "Wrong size on UABServerAchievement");
...
static_assert(sizeof(UABServerDSM) == 0x000038, "Wrong size on UABServerDSM");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ABServerEntitlement">();
	}
...
static_assert(alignof(UABServerEntitlement) == 0x000008, "Wrong alignment on UABServerEntitlement");
static_assert(sizeof(UABServerEntitlement) == 0x000038, "Wrong size on UABServerEntitlement");
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ABServerInventory">();
	}
...
static_assert(alignof(UABServerInventory) == 0x000008, "Wrong alignment on UABServerInventory");
static_assert(sizeof(UABServerInventory) == 0x000038, "Wrong size on UABServerInventory");
...
static_assert(sizeof(UABServerLobby) == 0x000038, "Wrong size on UABServerLobby");
...
static_assert(sizeof(UABServerMatchmaking) == 0x000038, "Wrong size on UABServerMatchmaking");
...
static_assert(sizeof(UABServerOauth2) == 0x000038, "Wrong size on UABServerOauth2");
...
static_assert(sizeof(UABServerSessionBrowser) == 0x000038, "Wrong size on UABServerSessionBrowser");
...
static_assert(sizeof(UABServerStatistic) == 0x000038, "Wrong size on UABServerStatistic");
...
static_assert(sizeof(UABServerUGC) == 0x000038, "Wrong size on UABServerUGC");
...
static_assert(sizeof(UABSessionAttribute) == 0x000038, "Wrong size on UABSessionAttribute");
...
static_assert(sizeof(UABSessionBrowser) == 0x000038, "Wrong size on UABSessionBrowser");

// Class AccelByteUe4Sdk.ABSessionHistory
// 0x0010 (0x0038 - 0x0028)
class UABSessionHistory final : public UObject
{
public:
	uint8                                         Pad_28[0x10];                                      // 0x0028(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void QueryGameSessionHistory(const TDelegate<void(const struct FAccelByteModelsGameSessionHistoriesResult& Response)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const EAccelByteGeneralSortBy& SortBy, int32 Offset, int32 Limit);

public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"ABSessionHistory">();
	}
	static class UABSessionHistory* GetDefaultObj()
	{
		return GetDefaultObjImpl<UABSessionHistory>();
	}
};
static_assert(alignof(UABSessionHistory) == 0x000008, "Wrong alignment on UABSessionHistory");
static_assert(sizeof(UABSessionHistory) == 0x000038, "Wrong size on UABSessionHistory");
...
static_assert(sizeof(UABSignaling) == 0x000038, "Wrong size on UABSignaling");
...
static_assert(sizeof(UABStatistic) == 0x000038, "Wrong size on UABStatistic");
...
static_assert(sizeof(UABUGC) == 0x000038, "Wrong size on UABUGC");
...
public:
	...
	void LoginByExchangeCodeForTokenV4(const class FString& Code, TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	void LoginWithDeviceId(TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)> OnError);
	void LoginWithDeviceIdV4(TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	void LoginWithLauncher(TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)> OnError);
	void LoginWithLauncherV4(TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	...
	void LoginWithOtherPlatformIdV4(const class FString& PlatformId, const class FString& PlatformToken, TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError, bool bCreateHeadless);
	void LoginWithOtherPlatformV4(EAccelBytePlatformType PlatformType, const class FString& PlatformToken, TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError, bool bCreateHeadless);
	...
	void LoginWithRefreshTokenV4(TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	...
	void LoginWithUsernameV4(const class FString& Username, const class FString& Password, TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	...
	void TryReloginV4(const class FString& PlatformUserID, TDelegate<void(const struct FAccelByteModelsLoginQueueTicketInfo& Response)> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrrMessage, struct FErrorOAuthInfo& ErrorInfo)> OnError);
	void UnlinkAllOtherPlatform(EAccelBytePlatformType PlatformType, TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)> OnError);
	void UnlinkAllOtherPlatformId(const class FString& PlatformId, TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)> OnError);
	...
	void UnlinkOtherPlatformId(const class FString& PlatformId, TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)> OnError);
	void UnlinkOtherPlatformWithCustomErrorHandler(EAccelBytePlatformType PlatformType, TDelegate<void()> OnSuccess, TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)> OnError);
...
static_assert(sizeof(UABUser) == 0x000038, "Wrong size on UABUser");
...
static_assert(sizeof(UABUtilities) == 0x000028, "Wrong size on UABUtilities");
...
static_assert(sizeof(UABWallet) == 0x000038, "Wrong size on UABWallet");
...
public:
	...
	static void GetAchievement(const class FString& AchievementCode, const TDelegate<void(struct FAccelByteModelsMultiLanguageAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetTags(const class FString& Name_0, const EAccelByteAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedPublicTag& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit);
	static void QueryAchievements(const class FString& Language, const EAccelByteAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedPublicAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit, const class FString& TagQuery, bool bGlobal);
	...
	static void QueryUserAchievements(const EAccelByteAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedUserAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit, bool PreferUnlocked, const class FString& TagQuery);
	static void QueryUserAchievementsV2(const EAccelByteGlobalAchievementListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsPaginatedUserAchievement& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, const int32& Offset, const int32& Limit, bool PreferUnlocked, const class FString& TagQuery);
	...
	void GetAchievementSuccess__DelegateSignature(const struct FAccelByteModelsMultiLanguageAchievement& Result);
	void GetTagSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedPublicTag& Result);
	void QueryAchievementsSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedPublicAchievement& Result);
	void QueryGlobalAchievementContributorsSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedGlobalAchievementContributors& Result);
	void QueryUserGlobalAchievementsSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedUserGlobalAchievement& Result);
	void QueryGlobalAchievementUserContributedSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedGlobalAchievementUserContributed& Result);
	void QueryUserAchievementsSuccess__DelegateSignature(const struct FAccelByteModelsPaginatedUserAchievement& Result);
...
static_assert(sizeof(UABCredentials) == 0x000038, "Wrong size on UABCredentials");
...
public:
	...
	class UABInventory*                           Inventory;                                         // 0x00D0(0x0008)(BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(offsetof(UABApiClient, Inventory) == 0x0000D0, "Member 'UABApiClient::Inventory' has a wrong offset!");
...
static_assert(sizeof(UABServerCredentials) == 0x000038, "Wrong size on UABServerCredentials");
...
static_assert(sizeof(UServerApiClient) == 0x000078, "Wrong size on UServerApiClient");
...
{
public:
	static void GetCategory(const class FString& ParentPath, const class FString& Language, const TDelegate<void(struct FAccelByteModelsCategoryInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetChildCategories(const class FString& Language, const class FString& CategoryPath, const TDelegate<void(TArray<struct FAccelByteModelsCategoryInfo>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetDescendantCategories(const class FString& Language, const class FString& CategoryPath, const TDelegate<void(TArray<struct FAccelByteModelsCategoryInfo>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetRootCategories(const class FString& Language, const TDelegate<void(TArray<struct FAccelByteModelsCategoryInfo>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void GetCategorySuccess__DelegateSignature(const struct FAccelByteModelsCategoryInfo& Result);
	void GetChildCategoriesSuccess__DelegateSignature(const TArray<struct FAccelByteModelsCategoryInfo>& Result);
	void GetDescendantCategoriesSuccess__DelegateSignature(const TArray<struct FAccelByteModelsCategoryInfo>& Result);
	void GetRootCategoriesSuccess__DelegateSignature(const TArray<struct FAccelByteModelsCategoryInfo>& Result);
...
public:
	...
	static void GetAllSlots(const TDelegate<void(TArray<struct FAccelByteModelsSlot>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetSlot(const class FString& SlotId, const TDelegate<void(TArray<uint8>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateSlot(const class FString& SlotId, const class FString& Filename, const TArray<uint8>& Data, const TArray<class FString>& Tags, const class FString& Label, const class FString& CustomAttribute, const TDelegate<void(struct FAccelByteModelsSlot& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateSlotMetadata(const class FString& SlotId, const class FString& Filename, const TArray<class FString>& Tags, const class FString& Label, const class FString& CustomAttribute, const TDelegate<void(struct FAccelByteModelsSlot& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void CreateSlotsSuccess__DelegateSignature(const struct FAccelByteModelsSlot& Result);
	void DeleteSlotSuccees__DelegateSignature();
	void GetAllSlotsSuccess__DelegateSignature(const TArray<struct FAccelByteModelsSlot>& Result);
	void GetSlotSuccess__DelegateSignature(const TArray<uint8>& Result);
	void UpdateSlotSuccess__DelegateSignature(const struct FAccelByteModelsSlot& Result);
	void UpdateSlotMetadataSuccess__DelegateSignature(const struct FAccelByteModelsSlot& Result);
...
public:
	...
	static class FString GetUniqueDisplayName();
...
{
public:
	static void GetCurrencyList(const class FString& Namespace, const TDelegate<void(TArray<struct FAccelByteModelsCurrencyList>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, EAccelByteCurrencyType CurrencyType);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void GetCurrencyListSuccess__DelegateSignature(const TArray<struct FAccelByteModelsCurrencyList>& Result);
...
{
public:
	static void QueryUserEntitlements(const class FString& EntitlementName, const class FString& ItemId, int32 Page, int32 Size, const TDelegate<void(struct FAccelByteModelsEntitlementPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, EAccelByteEntitlementClass EntitlementClass, EAccelByteAppType AppType);
	static void QueryUserEntitlementsMany(const class FString& EntitlementName, const TArray<class FString>& ItemIds, int32 Page, int32 Size, const TDelegate<void(struct FAccelByteModelsEntitlementPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError, EAccelByteEntitlementClass EntitlementClass, EAccelByteAppType AppType);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void QueryUserEntitlementSuccess__DelegateSignature(const struct FAccelByteModelsEntitlementPagingSlicedResult& Result);
...
{
public:
	static void BatchGetPublicGameProfiles(const TArray<class FString>& UserIDs, const TDelegate<void(TArray<struct FAccelByteModelsPublicGameProfile>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void CreateGameProfile(const struct FAccelByteModelsGameProfileRequest& GameProfileRequest, const TDelegate<void(struct FAccelByteModelsGameProfile& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	static void GetAllGameProfiles(const TDelegate<void(TArray<struct FAccelByteModelsGameProfile>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetGameProfile(const class FString& ProfileId, const TDelegate<void(struct FAccelByteModelsGameProfile& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetGameProfileAttribute(const class FString& ProfileId, const class FString& AttributeName, const TDelegate<void(struct FAccelByteModelsGameProfileAttribute& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGameProfile(const class FString& ProfileId, const struct FAccelByteModelsGameProfileRequest& GameProfileRequest, const TDelegate<void(struct FAccelByteModelsGameProfile& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGameProfileAttribute(const class FString& ProfileId, const struct FAccelByteModelsGameProfileAttribute& Attribute, const TDelegate<void(struct FAccelByteModelsGameProfile& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void BatchGetPublicGameProfilesSuccess__DelegateSignature(const TArray<struct FAccelByteModelsPublicGameProfile>& Result);
	void CreateGameProfileSuccess__DelegateSignature(const struct FAccelByteModelsGameProfile& Result);
	void DeleteGameProfileSuccess__DelegateSignature();
	void GetAllGameProfilesSuccess__DelegateSignature(const TArray<struct FAccelByteModelsGameProfile>& Result);
	void GetGameProfileSuccess__DelegateSignature(const struct FAccelByteModelsGameProfile& Result);
	void GetGameProfileAttributeSuccess__DelegateSignature(const struct FAccelByteModelsGameProfileAttribute& Result);
	void UpdateGameProfileSuccess__DelegateSignature(const struct FAccelByteModelsGameProfile& Result);
	void UpdateGameProfileAttributeSuccess__DelegateSignature(const struct FAccelByteModelsGameProfile& Result);
...
{
public:
	static void CreateGroup(const struct FAccelByteModelsCreateGroupRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	static void GetGroup(const class FString& GroupId, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetGroupList(const struct FAccelByteModelsGetGroupListRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGetGroupListResponse& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGroup(const class FString& GroupId, const bool bCompletelyReplace, const struct FAccelByteModelsGroupUpdatable& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGroupCustomAttributes(const class FString& GroupId, const struct FAccelByteModelsUpdateGroupCustomAttributesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGroupCustomRule(const class FString& GroupId, const struct FAccelByteModelsUpdateCustomRulesRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateGroupPredefinedRule(const class FString& GroupId, const EAccelByteAllowedAction& AllowedAction, const struct FAccelByteModelsUpdateGroupPredefinedRuleRequest& RequestContent, const TDelegate<void(struct FAccelByteModelsGroupInformation& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void CreateGroupSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
	void DeleteGroupSuccess__DelegateSignature();
	void DeleteGroupPredefinedRuleSuccess__DelegateSignature();
	void GetGroupSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
	void SearchGroupsSuccess__DelegateSignature(const struct FAccelByteModelsGetGroupListResponse& Result);
	void UpdateGroupSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
	void UpdateGroupCustomAttributesSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
	void UpdateGroupCustomRuleSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
	void UpdateGroupPredefinedRuleSuccess__DelegateSignature(const struct FAccelByteModelsGroupInformation& Result);
...
{
public:
	static void GetItemById(const class FString& ItemId, const class FString& Region, const class FString& Language, const TDelegate<void(struct FAccelByteModelsPopulatedItemInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetItemsByCriteria(const struct FAccelByteModelsItemCriteria& ItemCriteria, const int32& Offset, const int32& Limit, const TArray<EAccelByteItemListSortBy>& SortBy, const TDelegate<void(struct FAccelByteModelsItemPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void SearchItem(const class FString& Language, const class FString& Keyword, int32 Page, int32 Size, const class FString& Region, const TDelegate<void(struct FAccelByteModelsItemPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void GetItemByAppId(const class FString& AppId, const class FString& Region, const class FString& Language, const TDelegate<void(struct FAccelByteModelsItemInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	void GetItemByAppIdSuccess__DelegateSignature(const struct FAccelByteModelsItemInfo& Result);
	void GetItemByIdSuccess__DelegateSignature(const struct FAccelByteModelsPopulatedItemInfo& Result);
	void GetItemsByCriteriaSuccess__DelegateSignature(const struct FAccelByteModelsItemPagingSlicedResult& Result);
	void SearchItemSuccess__DelegateSignature(const struct FAccelByteModelsItemPagingSlicedResult& Result);
...
public:
	...
	static void BindEvent(const TDelegate<void()>& OnConnectSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnConnectError, const TDelegate<void(int32 StatusCode, const class FString& Reason, bool WasClean)>& OnConnectionClosed, const TDelegate<void(struct FAccelByteModelsLeavePartyNotice& Result)>& OnLeavePartyNotice, const TDelegate<void(struct FAccelByteModelsInvitationNotice& Result)>& OnInvitePartyInvitationNotice, const TDelegate<void(struct FAccelByteModelsPartyGetInvitedNotice& Result)>& OnInvitePartyGetInvitedNotice, const TDelegate<void(struct FAccelByteModelsPartyJoinNotice& Result)>& OnInvitePartyJoinNotice, const TDelegate<void(struct FAccelByteModelsGotKickedFromPartyNotice& Result)>& OnInvitePartyKickedNotice, const TDelegate<void(struct FAccelByteModelsPartyMemberConnectionNotice& Result)>& OnPartyConnectNotice, const TDelegate<void(struct FAccelByteModelsPartyMemberConnectionNotice& Result)>& OnPartyDisconnectNotice, const TDelegate<void(struct FAccelByteModelsPersonalMessageNotice& Result)>& OnPrivateMessageNotice, const TDelegate<void(struct FAccelByteModelsPartyMessageNotice& Result)>& OnPartyMessageNotice, const TDelegate<void(struct FAccelByteModelsUsersPresenceNotice& Result)>& OnUserPresenceNotice, const TDelegate<void(struct FAccelByteModelsNotificationMessage& Result)>& OnNotificationMessage, const TDelegate<void(struct FAccelByteModelsMatchmakingNotice& Result)>& OnMatchmakingNotice, const TDelegate<void(struct FAccelByteModelsReadyConsentNotice& Result)>& OnReadyConsentNotice, const TDelegate<void(struct FAccelByteModelsRematchmakingNotice& Result)>& OnRematchmakingNotice, const TDelegate<void(struct FAccelByteModelsDsNotice& Result)>& OnDsNotice, const TDelegate<void(struct FAccelByteModelsAcceptFriendsNotif& Result)>& OnAcceptFriendsNotifDelegate, const TDelegate<void(struct FAccelByteModelsRequestFriendsNotif& Result)>& OnRequestFriendsNotifDelegate, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnParsingError);
	...
	static void SetAcceptFriendResponseDelegate(TDelegate<void(struct FAccelByteModelsAcceptFriendsResponse& Result)> OnAcceptFriendsResponse);
	static void SetCancelFriendRequestResponseDelegate(TDelegate<void(struct FAccelByteModelsCancelFriendsResponse& Result)> OnCancelFriendsResponse);
	static void SetCancelMatchmakingResponseDelegate(TDelegate<void(struct FAccelByteModelsMatchmakingResponse& Result)> OnMatchmakingCancel);
	static void SetCreatePartyResponseDelegate(TDelegate<void(struct FAccelByteModelsCreatePartyResponse& Result)> OnCreatePartyResponse);
	static void SetDsNotifDelegate(TDelegate<void(struct FAccelByteModelsDsNotice& Result)> OnDsNotice);
	static void SetGetAllUserPresenceResponseDelegate(TDelegate<void(struct FAccelByteModelsGetOnlineUsersResponse& Result)> OnGetAllUserPresenceResponse);
	static void SetGetFriendshipStatusResponseDelegate(TDelegate<void(struct FAccelByteModelsGetFriendshipStatusResponse& Result)> OnGetFriendshipStatusResponse);
	static void SetInfoPartyResponseDelegate(TDelegate<void(struct FAccelByteModelsInfoPartyResponse& Result)> OnInfoPartyResponse);
	static void SetInvitePartyJoinResponseDelegate(TDelegate<void(struct FAccelByteModelsPartyJoinResponse& Result)> OnInvitePartyJoinResponse);
	static void SetInvitePartyKickMemberResponseDelegate(TDelegate<void(struct FAccelByteModelsKickPartyMemberResponse& Result)> OnInvitePartyKickMemberResponse);
	static void SetInvitePartyResponseDelegate(TDelegate<void(struct FAccelByteModelsPartyInviteResponse& Result)> OnInvitePartyResponse);
	static void SetLeavePartyResponseDelegate(TDelegate<void(struct FAccelByteModelsLeavePartyResponse& Result)> OnLeavePartyResponse);
	static void SetListIncomingFriendsResponseDelegate(TDelegate<void(struct FAccelByteModelsListIncomingFriendsResponse& Result)> OnListIncomingFriendsResponse);
	static void SetListOutgoingFriendsResponseDelegate(TDelegate<void(struct FAccelByteModelsListOutgoingFriendsResponse& Result)> OnListOutgoingFriendsResponse);
	static void SetLoadFriendsListResponseDelegate(TDelegate<void(struct FAccelByteModelsLoadFriendListResponse& Result)> OnLoadFriendListResponse);
	static void SetMatchmakingNotifDelegate(TDelegate<void(struct FAccelByteModelsMatchmakingNotice& Result)> OnMatchmakingNotice);
	static void SetPartyMessageResponseDelegate(TDelegate<void(struct FAccelByteModelsPartyMessageResponse& Result)> OnPartyMessageResponse);
	static void SetPresenceStatus(EAvailability State, const class FString& Activity);
	static void SetPrivateMessageResponseDelegate(TDelegate<void(struct FAccelByteModelsPersonalMessageResponse& Result)> OnPrivateMessageResponse);
	static void SetReadyConsentNotifDelegate(TDelegate<void(struct FAccelByteModelsReadyConsentNotice& Result)> OnReadyConsentNotice);
	static void SetReadyConsentResponseDelegate(TDelegate<void(struct FAccelByteModelsReadyConsentRequest& Result)> OnReadyConsentResponse);
	static void SetRejectConsentNotifDelegate(TDelegate<void(struct FAccelByteModelsRejectConsentNotice& Result)> OnRejectConsentNotice);
	static void SetRejectConsentResponseDelegate(TDelegate<void(struct FAccelByteModelsRejectConsentRequest& Result)> OnRejectConsentResponse);
	static void SetRejectFriendResponseDelegate(TDelegate<void(struct FAccelByteModelsRejectFriendsResponse& Result)> OnRejectFriendsResponse);
	static void SetRematchmakingNotifDelegate(TDelegate<void(struct FAccelByteModelsRematchmakingNotice& Result)> OnRematchmakingNotice);
	static void SetRequestFriendResponseDelegate(TDelegate<void(struct FAccelByteModelsRequestFriendsResponse& Result)> OnRequestFriendsResponseDelegate);
	static void SetStartMatchmakingResponseDelegate(TDelegate<void(struct FAccelByteModelsMatchmakingResponse& Result)> OnMatchmakingStart);
	static void SetUnfriendResponseDelegate(TDelegate<void(struct FAccelByteModelsUnfriendResponse& Result)> OnUnfriendResponse);
	static void SetUserPresenceResponseDelegate(TDelegate<void(struct FAccelByteModelsSetOnlineUsersResponse& Result)> OnUserPresenceResponse);
	static void UnbindDelegates();
	static void Unfriend(const class FString& UserId);

	void AcceptFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsAcceptFriendsResponse& Result);
	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void IncomingFriendNotif__DelegateSignature(const struct FAccelByteModelsRequestFriendsNotif& Result);
	void FriendAcceptFriendRequestNotif__DelegateSignature(const struct FAccelByteModelsAcceptFriendsNotif& Result);
	void DsNotice__DelegateSignature(const struct FAccelByteModelsDsNotice& Result);
	void RematchmakingNotice__DelegateSignature(const struct FAccelByteModelsRematchmakingNotice& Result);
	void ReadyConsentNotice__DelegateSignature(const struct FAccelByteModelsReadyConsentNotice& Result);
	void MatchmakingNotice__DelegateSignature(const struct FAccelByteModelsMatchmakingNotice& Result);
	void NotificationMessage__DelegateSignature(const struct FAccelByteModelsNotificationMessage& Result);
	void UserPresenceNotice__DelegateSignature(const struct FAccelByteModelsUsersPresenceNotice& Result);
	void PartyMessageNotice__DelegateSignature(const struct FAccelByteModelsPartyMessageNotice& Result);
	void PrivateMessageNotice__DelegateSignature(const struct FAccelByteModelsPersonalMessageNotice& Result);
	void PartyMemberDisconnectNotice__DelegateSignature(const struct FAccelByteModelsPartyMemberConnectionNotice& Result);
	void PartyMemberConnectNotice__DelegateSignature(const struct FAccelByteModelsPartyMemberConnectionNotice& Result);
	void InvitePartyKickedNotice__DelegateSignature(const struct FAccelByteModelsGotKickedFromPartyNotice& Result);
	void InvitePartyJoinNotice__DelegateSignature(const struct FAccelByteModelsPartyJoinNotice& Result);
	void InvitePartyGetInvitedNotice__DelegateSignature(const struct FAccelByteModelsPartyGetInvitedNotice& Result);
	void InvitePartyInvitationNotice__DelegateSignature(const struct FAccelByteModelsInvitationNotice& Result);
	void LeavePartyNotice__DelegateSignature(const struct FAccelByteModelsLeavePartyNotice& Result);
	void ConnectionClosed__DelegateSignature(int32 StatusCode, const class FString& Reason, bool WasClean);
	void ConnectSuccess__DelegateSignature();
	void CancelFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsCancelFriendsResponse& Result);
	void CreatePartyResponse__DelegateSignature(const struct FAccelByteModelsCreatePartyResponse& Result);
	void GetAllFriendsStatusResponse__DelegateSignature(const struct FAccelByteModelsGetOnlineUsersResponse& Result);
	void GetFriendshipStatusResponseDelegate__DelegateSignature(const struct FAccelByteModelsGetFriendshipStatusResponse& Result);
	void InfoPartyResponse__DelegateSignature(const struct FAccelByteModelsInfoPartyResponse& Result);
	void InvitePartyJoinResponse__DelegateSignature(const struct FAccelByteModelsPartyJoinResponse& Result);
	void InvitePartyKickMemberResponse__DelegateSignature(const struct FAccelByteModelsKickPartyMemberResponse& Result);
	void InvitePartyResponse__DelegateSignature(const struct FAccelByteModelsPartyInviteResponse& Result);
	void LeavePartyResponse__DelegateSignature(const struct FAccelByteModelsLeavePartyResponse& Result);
	void ListIncomingFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsListIncomingFriendsResponse& Result);
	void ListOutgoingFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsListOutgoingFriendsResponse& Result);
	void LoadFriendListResponseDelegate__DelegateSignature(const struct FAccelByteModelsLoadFriendListResponse& Result);
	void MatchmakingResponse__DelegateSignature(const struct FAccelByteModelsMatchmakingResponse& Result);
	void PartyMessageResponse__DelegateSignature(const struct FAccelByteModelsPartyMessageResponse& Result);
	void PrivateMessageResponse__DelegateSignature(const struct FAccelByteModelsPersonalMessageResponse& Result);
	void ReadyConsentResponse__DelegateSignature(const struct FAccelByteModelsReadyConsentRequest& Result);
	void RejectConsentNotice__DelegateSignature(const struct FAccelByteModelsRejectConsentNotice& Result);
	void RejectConsentResponse__DelegateSignature(const struct FAccelByteModelsRejectConsentRequest& Result);
	void RejectFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsRejectFriendsResponse& Result);
	void RequestFriendsResponseDelegate__DelegateSignature(const struct FAccelByteModelsRequestFriendsResponse& Result);
	void UnfriendResponseDelegate__DelegateSignature(const struct FAccelByteModelsUnfriendResponse& Result);
	void SetUserPresenceResponse__DelegateSignature(const struct FAccelByteModelsSetOnlineUsersResponse& Result);
...
{
public:
	static void CancelOrder(const class FString& OrderNo, const TDelegate<void(struct FAccelByteModelsOrderInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void CreateNewOrder(const struct FAccelByteModelsOrderCreate& OrderCreate, const TDelegate<void(struct FAccelByteModelsOrderInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserOrder(const class FString& OrderNo, const TDelegate<void(struct FAccelByteModelsOrderInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserOrderHistory(const class FString& OrderNo, const TDelegate<void(TArray<struct FAccelByteModelsOrderHistoryInfo>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserOrders(int32 Page, int32 Size, const TDelegate<void(struct FAccelByteModelsPagedOrderInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void PreviewUserOrder(const struct FAccelByteModelsUserPreviewOrderRequest& OrderPreviewRequest, const TDelegate<void(struct FAccelByteModelsUserPreviewOrderResponse& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void CancelOrderSuccess__DelegateSignature(const struct FAccelByteModelsOrderInfo& Result);
	void CreateNewOrderSuccess__DelegateSignature(const struct FAccelByteModelsOrderInfo& Result);
	void GetUserOrderSuccess__DelegateSignature(const struct FAccelByteModelsOrderInfo& Result);
	void GetUserOrderHistorySuccess__DelegateSignature(const TArray<struct FAccelByteModelsOrderHistoryInfo>& Result);
	void GetUserOrdersSuccess__DelegateSignature(const struct FAccelByteModelsPagedOrderInfo& Result);
	void PreviewUserOrderSuccess__DelegateSignature(const struct FAccelByteModelsUserPreviewOrderResponse& Result);
...
{
public:
	static void GetRewardByRewardCode(const class FString& RewardCode, const TDelegate<void(struct FAccelByteModelsRewardInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetRewardByRewardId(const class FString& RewardId, const TDelegate<void(struct FAccelByteModelsRewardInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void QueryRewards(const class FString& EventTopic, int32 Offset, int32 Limit, const EAccelByteRewardListSortBy& SortBy, const TDelegate<void(struct FAccelByteModelsQueryReward& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void GetRewardByRewardCodeSuccess__DelegateSignature(const struct FAccelByteModelsRewardInfo& Result);
	void GetRewardByRewardIdSuccess__DelegateSignature(const struct FAccelByteModelsRewardInfo& Result);
	void QueryRewardsSuccess__DelegateSignature(const struct FAccelByteModelsQueryReward& Result);
...
public:
	...
	class FString                                 BasicServerUrl;                                    // 0x00A0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 DSMControllerServerUrl;                            // 0x00B0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 StatisticServerUrl;                                // 0x00C0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 PlatformServerUrl;                                 // 0x00D0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 QosManagerServerUrl;                               // 0x00E0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 GameTelemetryServerUrl;                            // 0x00F0(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AchievementServerUrl;                              // 0x0100(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 UGCServerUrl;                                      // 0x0110(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MatchmakingServerUrl;                              // 0x0120(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 LobbyServerUrl;                                    // 0x0130(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FString                                 SeasonPassServerUrl;                               // 0x0150(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SessionBrowserServerUrl;                           // 0x0160(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SessionServerUrl;                                  // 0x0170(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ChatServerUrl;                                     // 0x0180(0x0010)(Edit, ZeroConstructor, Config, GlobalConfig, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         QosPingTimeout;                                    // 0x0190(0x0004)(Edit, ZeroConstructor, Config, GlobalConfig, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_194[0x4];                                      // 0x0194(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	class FString                                 DSHubServerUrl;                                    // 0x0198(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MatchmakingV2ServerUrl;                            // 0x01A8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AMSServerWatchdogUrl;                              // 0x01B8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	int32                                         AMSHeartbeatInterval;                              // 0x01C8(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSendPredefinedEvent;                              // 0x01CC(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAccelByteServerSettings) == 0x0001D0, "Wrong size on UAccelByteServerSettings");
...
static_assert(offsetof(UAccelByteServerSettings, BasicServerUrl) == 0x0000A0, "Member 'UAccelByteServerSettings::BasicServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, DSMControllerServerUrl) == 0x0000B0, "Member 'UAccelByteServerSettings::DSMControllerServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, StatisticServerUrl) == 0x0000C0, "Member 'UAccelByteServerSettings::StatisticServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, PlatformServerUrl) == 0x0000D0, "Member 'UAccelByteServerSettings::PlatformServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, QosManagerServerUrl) == 0x0000E0, "Member 'UAccelByteServerSettings::QosManagerServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, GameTelemetryServerUrl) == 0x0000F0, "Member 'UAccelByteServerSettings::GameTelemetryServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, AchievementServerUrl) == 0x000100, "Member 'UAccelByteServerSettings::AchievementServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, UGCServerUrl) == 0x000110, "Member 'UAccelByteServerSettings::UGCServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, MatchmakingServerUrl) == 0x000120, "Member 'UAccelByteServerSettings::MatchmakingServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, LobbyServerUrl) == 0x000130, "Member 'UAccelByteServerSettings::LobbyServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, CloudSaveServerUrl) == 0x000140, "Member 'UAccelByteServerSettings::CloudSaveServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, SeasonPassServerUrl) == 0x000150, "Member 'UAccelByteServerSettings::SeasonPassServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, SessionBrowserServerUrl) == 0x000160, "Member 'UAccelByteServerSettings::SessionBrowserServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, SessionServerUrl) == 0x000170, "Member 'UAccelByteServerSettings::SessionServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, ChatServerUrl) == 0x000180, "Member 'UAccelByteServerSettings::ChatServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, QosPingTimeout) == 0x000190, "Member 'UAccelByteServerSettings::QosPingTimeout' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, DSHubServerUrl) == 0x000198, "Member 'UAccelByteServerSettings::DSHubServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, MatchmakingV2ServerUrl) == 0x0001A8, "Member 'UAccelByteServerSettings::MatchmakingV2ServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, AMSServerWatchdogUrl) == 0x0001B8, "Member 'UAccelByteServerSettings::AMSServerWatchdogUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, AMSHeartbeatInterval) == 0x0001C8, "Member 'UAccelByteServerSettings::AMSHeartbeatInterval' has a wrong offset!");
static_assert(offsetof(UAccelByteServerSettings, bSendPredefinedEvent) == 0x0001CC, "Member 'UAccelByteServerSettings::bSendPredefinedEvent' has a wrong offset!");
...
static_assert(sizeof(UAccelByteServerSettingsDev) == 0x0001D0, "Wrong size on UAccelByteServerSettingsDev");
...
static_assert(sizeof(UAccelByteServerSettingsCert) == 0x0001D0, "Wrong size on UAccelByteServerSettingsCert");
...
static_assert(sizeof(UAccelByteServerSettingsProd) == 0x0001D0, "Wrong size on UAccelByteServerSettingsProd");
...
public:
	...
	static class FString GetInventoryServerUrl();
	...
	static void SetInventoryServerUrl(const class FString& InventoryServerUrl);
...
public:
	...
	class FString                                 ChatServerUrl;                                     // 0x0118(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 LeaderboardServerUrl;                              // 0x0128(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	class FString                                 GameTelemetryServerUrl;                            // 0x0148(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AgreementServerUrl;                                // 0x0158(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AchievementServerUrl;                              // 0x0168(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SessionBrowserServerUrl;                           // 0x0178(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 TurnManagerServerUrl;                              // 0x0188(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 UGCServerUrl;                                      // 0x0198(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 InventoryServerUrl;                                // 0x01A8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ReportingServerUrl;                                // 0x01B8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SessionServerUrl;                                  // 0x01C8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SessionHistoryServerUrl;                           // 0x01D8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 MatchmakingV2ServerUrl;                            // 0x01E8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 ChallengeServerUrl;                                // 0x01F8(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 LoginQueueServerUrl;                               // 0x0208(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 AppId;                                             // 0x0218(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 CustomerName;                                      // 0x0228(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 SettingsEnvironment;                               // 0x0238(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class FString                                 HeartBeatData;                                     // 0x0248(0x0010)(Edit, ZeroConstructor, Config, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         QosLatencyPollIntervalSecs;                        // 0x0258(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         QosServerLatencyPollIntervalSecs;                  // 0x025C(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                         QosPingTimeout;                                    // 0x0260(0x0004)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableHttpCache;                                  // 0x0264(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	EHttpCacheType                                HttpCacheType;                                     // 0x0265(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bSendPredefinedEvent;                              // 0x0266(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bServerUseAMS;                                     // 0x0267(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          bEnableGameTelemetryCache;                         // 0x0268(0x0001)(Edit, ZeroConstructor, Config, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UAccelByteSettings) == 0x000270, "Wrong size on UAccelByteSettings");
...
static_assert(offsetof(UAccelByteSettings, ChatServerUrl) == 0x000118, "Member 'UAccelByteSettings::ChatServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, LeaderboardServerUrl) == 0x000128, "Member 'UAccelByteSettings::LeaderboardServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, CloudSaveServerUrl) == 0x000138, "Member 'UAccelByteSettings::CloudSaveServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, GameTelemetryServerUrl) == 0x000148, "Member 'UAccelByteSettings::GameTelemetryServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, AgreementServerUrl) == 0x000158, "Member 'UAccelByteSettings::AgreementServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, AchievementServerUrl) == 0x000168, "Member 'UAccelByteSettings::AchievementServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, SessionBrowserServerUrl) == 0x000178, "Member 'UAccelByteSettings::SessionBrowserServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, TurnManagerServerUrl) == 0x000188, "Member 'UAccelByteSettings::TurnManagerServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, UGCServerUrl) == 0x000198, "Member 'UAccelByteSettings::UGCServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, InventoryServerUrl) == 0x0001A8, "Member 'UAccelByteSettings::InventoryServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, ReportingServerUrl) == 0x0001B8, "Member 'UAccelByteSettings::ReportingServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, SessionServerUrl) == 0x0001C8, "Member 'UAccelByteSettings::SessionServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, SessionHistoryServerUrl) == 0x0001D8, "Member 'UAccelByteSettings::SessionHistoryServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, MatchmakingV2ServerUrl) == 0x0001E8, "Member 'UAccelByteSettings::MatchmakingV2ServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, ChallengeServerUrl) == 0x0001F8, "Member 'UAccelByteSettings::ChallengeServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, LoginQueueServerUrl) == 0x000208, "Member 'UAccelByteSettings::LoginQueueServerUrl' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, AppId) == 0x000218, "Member 'UAccelByteSettings::AppId' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, CustomerName) == 0x000228, "Member 'UAccelByteSettings::CustomerName' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, SettingsEnvironment) == 0x000238, "Member 'UAccelByteSettings::SettingsEnvironment' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, HeartBeatData) == 0x000248, "Member 'UAccelByteSettings::HeartBeatData' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, QosLatencyPollIntervalSecs) == 0x000258, "Member 'UAccelByteSettings::QosLatencyPollIntervalSecs' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, QosServerLatencyPollIntervalSecs) == 0x00025C, "Member 'UAccelByteSettings::QosServerLatencyPollIntervalSecs' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, QosPingTimeout) == 0x000260, "Member 'UAccelByteSettings::QosPingTimeout' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, bEnableHttpCache) == 0x000264, "Member 'UAccelByteSettings::bEnableHttpCache' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, HttpCacheType) == 0x000265, "Member 'UAccelByteSettings::HttpCacheType' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, bSendPredefinedEvent) == 0x000266, "Member 'UAccelByteSettings::bSendPredefinedEvent' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, bServerUseAMS) == 0x000267, "Member 'UAccelByteSettings::bServerUseAMS' has a wrong offset!");
static_assert(offsetof(UAccelByteSettings, bEnableGameTelemetryCache) == 0x000268, "Member 'UAccelByteSettings::bEnableGameTelemetryCache' has a wrong offset!");
...
static_assert(sizeof(UAccelByteSettingsDev) == 0x000270, "Wrong size on UAccelByteSettingsDev");
...
static_assert(sizeof(UAccelByteSettingsCert) == 0x000270, "Wrong size on UAccelByteSettingsCert");
...
static_assert(sizeof(UAccelByteSettingsProd) == 0x000270, "Wrong size on UAccelByteSettingsProd");
...
public:
	...
	static class FString GetLobbyServerUrl();
	static class FString GetLoginQueueServerUrl();
	static class FString GetMatchmakingV2ServerUrl();
	static class FString GetNamespace();
	static class FString GetPlatformServerUrl();
	static class FString GetPublisherNamespace();
	...
	static class FString GetSessionBrowserServerUrl();
	static class FString GetSessionHistoryServerUrl();
	static class FString GetSessionServerUrl();
	static class FString GetStatisticServerUrl();
	...
	static void SetLobbyServerUrl(const class FString& LobbyServerUrl);
	static void SetLoginQueueServerUrl(const class FString& LoginQueueServerUrl);
	static void SetMatchmakingV2ServerUrl(const class FString& MatchmakingV2ServerUrl);
	static void SetNamespace(const class FString& Namespace);
	static void SetPlatformServerUrl(const class FString& PlatformServerUrl);
	static void SetPublisherNamespace(const class FString& PublisherNamespace);
	...
	static void SetSessionBrowserServerUrl(const class FString& SessionBrowserServerUrl);
	static void SetSessionHistoryServerUrl(const class FString& SessionHistoryServerUrl);
	static void SetSessionServerUrl(const class FString& SessionServerUrl);
	static void SetStatisticServerUrl(const class FString& StatisticServerUrl);
...
{
public:
	static void CreateUserStatItems(const TArray<class FString>& StatCodes, const TDelegate<void(TArray<struct FAccelByteModelsBulkStatItemOperationResult>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetAllUserStatItems(const TDelegate<void(struct FAccelByteModelsUserStatItemPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetGlobalStatItemsByStatCode(const class FString& StatCode, const TDelegate<void(struct FAccelByteModelsGlobalStatItemValueResponse& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserStatItems(const TArray<class FString>& StatCodes, const TArray<class FString>& Tags, const TDelegate<void(struct FAccelByteModelsUserStatItemPagingSlicedResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void IncrementUserStatItems(const TArray<struct FAccelByteModelsBulkStatItemInc>& Data, const TDelegate<void(TArray<struct FAccelByteModelsBulkStatItemOperationResult>& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void BulkAddUserStatItemValueSuccess__DelegateSignature(const TArray<struct FAccelByteModelsBulkStatItemOperationResult>& Result);
	void CreateUserStatItemsSuccess__DelegateSignature(const TArray<struct FAccelByteModelsBulkStatItemOperationResult>& Result);
	void GetAllUserStatItemsSuccess__DelegateSignature(const struct FAccelByteModelsUserStatItemPagingSlicedResult& Result);
	void GlobalStatItemDelegate__DelegateSignature(const struct FAccelByteModelsGlobalStatItemValueResponse& Result);
	void GetUserStatItemsSuccess__DelegateSignature(const struct FAccelByteModelsUserStatItemPagingSlicedResult& Result);
...
public:
	...
	static void GetPlatformLinks(const TDelegate<void(struct FPagedPlatformLinks& PlatformLinks)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserEligibleToPlay(const TDelegate<void(bool Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	static void Register(const class FString& Username, const class FString& Password, const class FString& DisplayName, const class FString& Country, const class FString& DateOfBirth, const TDelegate<void(struct FRegisterResponse& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	...
	static void UnlinkAllOtherPlatform(EAccelBytePlatformType PlatformType, const TDelegate<void()>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)>& OnError);
	static void UnlinkAllOtherPlatformId(const class FString& PlatformId, const TDelegate<void()>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)>& OnError);
	...
	static void UnlinkOtherPlatformId(const class FString& PlatformId, const TDelegate<void()>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)>& OnError);
	static void UnlinkOtherPlatformWithCustomErrorHandler(EAccelBytePlatformType PlatformType, const TDelegate<void()>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage, struct FJsonObjectWrapper& ErrorObject)>& OnError);
	static void Upgrade(const class FString& Username, const class FString& Password, const TDelegate<void(struct FAccountUserData& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpgradeAndVerify(const class FString& Username, const class FString& Password, const class FString& VerificationCode, const TDelegate<void(struct FAccountUserData& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
...
{
public:
	static void CreateUserProfile(const struct FAccelByteModelsUserProfileCreateRequest& ProfileCreateRequest, const TDelegate<void(struct FAccelByteModelsUserProfileInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GenerateUploadURL(const class FString& Folder, EAccelByteFileType FileType, const TDelegate<void(struct FAccelByteModelsUserProfileUploadURLResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GenerateUploadURLForUserContent(const class FString& UserId, EAccelByteFileType FileType, const TDelegate<void(struct FAccelByteModelsUserProfileUploadURLResult& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetPrivateCustomAttributes(const TDelegate<void(struct FJsonObjectWrapper& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetUserProfile(const TDelegate<void(struct FAccelByteModelsUserProfileInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdatePrivateCustomAttributes(const struct FJsonObjectWrapper& PrivateCustomAttributesUpdateRequest, const TDelegate<void(struct FJsonObjectWrapper& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void UpdateUserProfile(const struct FAccelByteModelsUserProfileUpdateRequest& ProfileUpdateRequest, const TDelegate<void(struct FAccelByteModelsUserProfileInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void CreateUserProfileSuccess__DelegateSignature(const struct FAccelByteModelsUserProfileInfo& Result);
	void GenerateUploadURLSuccess__DelegateSignature(const struct FAccelByteModelsUserProfileUploadURLResult& Result);
	void GenerateUploadURLForUserContentSuccess__DelegateSignature(const struct FAccelByteModelsUserProfileUploadURLResult& Result);
	void GetPrivateCustomAttributesSuccess__DelegateSignature(const struct FJsonObjectWrapper& Result);
	void GetUserProfileSuccess__DelegateSignature(const struct FAccelByteModelsUserProfileInfo& Result);
	void UpdatePrivateCustomAttributesSuccess__DelegateSignature(const struct FJsonObjectWrapper& Result);
	void UpdateUserProfileSuccess__DelegateSignature(const struct FAccelByteModelsUserProfileInfo& Result);
...
{
public:
	static void GetWalletInfoByCurrencyCode(const class FString& CurrencyCode, const TDelegate<void(struct FAccelByteModelsWalletInfo& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);
	static void GetWalletInfoByCurrencyCodeV2(const class FString& CurrencyCode, const TDelegate<void(struct FAccelByteModelsWalletInfoResponse& Result)>& OnSuccess, const TDelegate<void(int32 ErrorCode, const class FString& ErrorMessage)>& OnError);

	void BlueprintErrorHandler__DelegateSignature(int32 ErrorCode, const class FString& ErrorMessage);
	void GetWalletByCurrencyCodeSuccess__DelegateSignature(const struct FAccelByteModelsWalletInfo& Result);
	void GetWalletInfoResponseSuccess__DelegateSignature(const struct FAccelByteModelsWalletInfoResponse& Result);
