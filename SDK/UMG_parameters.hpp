...
// Function UMG.WidgetBlueprintLibrary.GetWidgetCenterInViewport
// 0x0018 (0x0018 - 0x0000)
struct WidgetBlueprintLibrary_GetWidgetCenterInViewport final
{
public:
	class UObject*                                WorldContextObject;                                // 0x0000(0x0008)(Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UWidget*                                TargetWidget;                                      // 0x0008(0x0008)(Parm, ZeroConstructor, InstancedReference, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(WidgetBlueprintLibrary_GetWidgetCenterInViewport) == 0x000008, "Wrong alignment on WidgetBlueprintLibrary_GetWidgetCenterInViewport");
static_assert(sizeof(WidgetBlueprintLibrary_GetWidgetCenterInViewport) == 0x000018, "Wrong size on WidgetBlueprintLibrary_GetWidgetCenterInViewport");
static_assert(offsetof(WidgetBlueprintLibrary_GetWidgetCenterInViewport, WorldContextObject) == 0x000000, "Member 'WidgetBlueprintLibrary_GetWidgetCenterInViewport::WorldContextObject' has a wrong offset!");
static_assert(offsetof(WidgetBlueprintLibrary_GetWidgetCenterInViewport, TargetWidget) == 0x000008, "Member 'WidgetBlueprintLibrary_GetWidgetCenterInViewport::TargetWidget' has a wrong offset!");
static_assert(offsetof(WidgetBlueprintLibrary_GetWidgetCenterInViewport, ReturnValue) == 0x000010, "Member 'WidgetBlueprintLibrary_GetWidgetCenterInViewport::ReturnValue' has a wrong offset!");
