...
bool UChromaSDKPluginBPLibrary::IsChromaSDKAvailable()
{
	...
	if (Func == nullptr)
		Func = StaticClass()->GetFunction("ChromaSDKPluginBPLibrary", "IsChromaSDKAvailable");

	Params::ChromaSDKPluginBPLibrary_IsChromaSDKAvailable Parms{};
...
void UChromaSDKSubsystem::PlayAnimation(const class FString& AnimationName, bool bLooping)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChromaSDKSubsystem", "PlayAnimation");

	Params::ChromaSDKSubsystem_PlayAnimation Parms{};
...
// Function ChromaSDKPlugin.ChromaSDKSubsystem.StopAllAnimations
// (Final, Native, Public)

void UChromaSDKSubsystem::StopAllAnimations()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("ChromaSDKSubsystem", "StopAllAnimations");
