...
public:
	...
	TMap<class FString, class FName>              CachedPlatformPlayerNames;                         // 0x0088(0x0050)(Transient, NativeAccessSpecifierPrivate)
...
static_assert(sizeof(UBaseMediaSource) == 0x0000D8, "Wrong size on UBaseMediaSource");
static_assert(offsetof(UBaseMediaSource, PlayerName) == 0x000080, "Member 'UBaseMediaSource::PlayerName' has a wrong offset!");
static_assert(offsetof(UBaseMediaSource, CachedPlatformPlayerNames) == 0x000088, "Member 'UBaseMediaSource::CachedPlatformPlayerNames' has a wrong offset!");
...
{
public:
	class FString                                 FilePath;                                          // 0x00D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	bool                                          PrecacheFile;                                      // 0x00E8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, AdvancedDisplay, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UFileMediaSource) == 0x000100, "Wrong size on UFileMediaSource");
static_assert(offsetof(UFileMediaSource, FilePath) == 0x0000D8, "Member 'UFileMediaSource::FilePath' has a wrong offset!");
static_assert(offsetof(UFileMediaSource, PrecacheFile) == 0x0000E8, "Member 'UFileMediaSource::PrecacheFile' has a wrong offset!");
...
{
public:
	class FString                                 StreamUrl;                                         // 0x00D8(0x0010)(Edit, BlueprintVisible, ZeroConstructor, AssetRegistrySearchable, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UStreamMediaSource) == 0x0000E8, "Wrong size on UStreamMediaSource");
static_assert(offsetof(UStreamMediaSource, StreamUrl) == 0x0000D8, "Member 'UStreamMediaSource::StreamUrl' has a wrong offset!");
...
{
public:
	bool                                          bUseTimeSynchronization;                           // 0x00D8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_D9[0x3];                                       // 0x00D9(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	int32                                         FrameDelay;                                        // 0x00DC(0x0004)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	double                                        TimeDelay;                                         // 0x00E0(0x0008)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UTimeSynchronizableMediaSource) == 0x0000E8, "Wrong size on UTimeSynchronizableMediaSource");
static_assert(offsetof(UTimeSynchronizableMediaSource, bUseTimeSynchronization) == 0x0000D8, "Member 'UTimeSynchronizableMediaSource::bUseTimeSynchronization' has a wrong offset!");
static_assert(offsetof(UTimeSynchronizableMediaSource, FrameDelay) == 0x0000DC, "Member 'UTimeSynchronizableMediaSource::FrameDelay' has a wrong offset!");
static_assert(offsetof(UTimeSynchronizableMediaSource, TimeDelay) == 0x0000E0, "Member 'UTimeSynchronizableMediaSource::TimeDelay' has a wrong offset!");
