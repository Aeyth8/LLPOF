...
namespace Offsets
{
	constexpr int32 GObjects          = 0x05EDC8E0;
	constexpr int32 AppendString      = 0x01D56540;
	constexpr int32 GNames            = 0x05EA0580;
	constexpr int32 GWorld            = 0x06021670;
	constexpr int32 ProcessEvent      = 0x01F4A9E0;
