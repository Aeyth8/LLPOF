...
// Function ChromaSDKPlugin.ChromaSDKPluginBPLibrary.IsChromaSDKAvailable
// 0x0001 (0x0001 - 0x0000)
struct ChromaSDKPluginBPLibrary_IsChromaSDKAvailable final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(ChromaSDKPluginBPLibrary_IsChromaSDKAvailable) == 0x000001, "Wrong alignment on ChromaSDKPluginBPLibrary_IsChromaSDKAvailable");
static_assert(sizeof(ChromaSDKPluginBPLibrary_IsChromaSDKAvailable) == 0x000001, "Wrong size on ChromaSDKPluginBPLibrary_IsChromaSDKAvailable");
static_assert(offsetof(ChromaSDKPluginBPLibrary_IsChromaSDKAvailable, ReturnValue) == 0x000000, "Member 'ChromaSDKPluginBPLibrary_IsChromaSDKAvailable::ReturnValue' has a wrong offset!");
...
// Function ChromaSDKPlugin.ChromaSDKSubsystem.PlayAnimation
// 0x0018 (0x0018 - 0x0000)
struct ChromaSDKSubsystem_PlayAnimation final
{
public:
	class FString                                 AnimationName;                                     // 0x0000(0x0010)(Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(alignof(ChromaSDKSubsystem_PlayAnimation) == 0x000008, "Wrong alignment on ChromaSDKSubsystem_PlayAnimation");
static_assert(sizeof(ChromaSDKSubsystem_PlayAnimation) == 0x000018, "Wrong size on ChromaSDKSubsystem_PlayAnimation");
static_assert(offsetof(ChromaSDKSubsystem_PlayAnimation, AnimationName) == 0x000000, "Member 'ChromaSDKSubsystem_PlayAnimation::AnimationName' has a wrong offset!");
static_assert(offsetof(ChromaSDKSubsystem_PlayAnimation, bLooping) == 0x000010, "Member 'ChromaSDKSubsystem_PlayAnimation::bLooping' has a wrong offset!");
