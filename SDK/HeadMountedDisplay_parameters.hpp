...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime, bProvidedLinearAcceleration) == 0x00005C, "Member 'HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime::bProvidedLinearAcceleration' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime, LinearAcceleration) == 0x000060, "Member 'HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime::LinearAcceleration' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime, ReturnValue) == 0x00006C, "Member 'HeadMountedDisplayFunctionLibrary_GetControllerTransformForTime::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(HeadMountedDisplayFunctionLibrary_GetPlayAreaRect) == 0x000040, "Wrong size on HeadMountedDisplayFunctionLibrary_GetPlayAreaRect");
...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetPlayAreaRect, OutRect) == 0x000030, "Member 'HeadMountedDisplayFunctionLibrary_GetPlayAreaRect::OutRect' has a wrong offset!");
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetPlayAreaRect, ReturnValue) == 0x000038, "Member 'HeadMountedDisplayFunctionLibrary_GetPlayAreaRect::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(HeadMountedDisplayFunctionLibrary_GetTrackingOriginTransform) == 0x000050, "Wrong size on HeadMountedDisplayFunctionLibrary_GetTrackingOriginTransform");
...
static_assert(offsetof(HeadMountedDisplayFunctionLibrary_GetTrackingOriginTransform, ReturnValue) == 0x000040, "Member 'HeadMountedDisplayFunctionLibrary_GetTrackingOriginTransform::ReturnValue' has a wrong offset!");
